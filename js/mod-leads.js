...
const ModLeads = {
  ...
  render() {
    ...
    const qualified = rows.filter((r) => this._truthy(r.QualifiedLeads));
    ...
    main.innerHTML = `
      ...
      ${Components.kpiRow([
        ...
        { label: "Revenue", value: Utils.fmtCurrency(revenue, "USD"), icon: "fa-sack-dollar" },
      ...
      <div class="panel">
        ...
        ${this.showRecords ? Components.dataTable(rows, [
          ...
          { key: "Revenue", label: "Revenue", fmt: (v) => v ? Utils.fmtCurrency(v, "USD") : "—" },
