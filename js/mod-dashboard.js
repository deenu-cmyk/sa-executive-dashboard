...
const ModDashboard = {
  ...
  _renderKPIs(rows) {
    ...
    const cards = [
      ...
      { label: "Total Revenue", value: totalRevenue, icon: "fa-sack-dollar", fmt: (v) => Utils.fmtCurrency(v), trend: 6.1 },
      { label: "Conversion Rate", value: conversion, icon: "fa-bullseye", fmt: (v) => Utils.fmtPercent(v), trend: 1.4 },
      { label: "Avg Deal Size", value: avgDeal, icon: "fa-scale-balanced", fmt: (v) => Utils.fmtCurrency(v), trend: -0.6 },
      ...
      { label: "Weekly Revenue", value: weekRevenue, icon: "fa-calendar-week", fmt: (v) => Utils.fmtCurrency(v), trend: 3.3 },
      { label: "Monthly Revenue", value: monthRevenue, icon: "fa-calendar", fmt: (v) => Utils.fmtCurrency(v), trend: 5.7 },
      { label: "Yearly Revenue", value: yearRevenue, icon: "fa-chart-column", fmt: (v) => Utils.fmtCurrency(v), trend: 8.9 },
