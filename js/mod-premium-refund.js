...
const ModPremium = {
  ...
  render() {
    ...
    main.innerHTML = `
      ...
      ${Components.kpiRow([
        { label: "Premium Leads", value: Utils.fmtNumber(stats.premiumLeads), icon: "fa-star", trend: withTrend("premiumLeads") },
        { label: "Elite Leads", value: Utils.fmtNumber(stats.eliteLeads), icon: "fa-crown", trend: withTrend("eliteLeads") },
        ...
        { label: "Premium Conversion", value: Utils.fmtPercent(stats.premiumConversion), icon: "fa-bullseye", trend: withTrend("premiumConversion") },
        { label: "Elite Conversion", value: Utils.fmtPercent(stats.eliteConversion), icon: "fa-bullseye", trend: withTrend("eliteConversion") },
      ])}
