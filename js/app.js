...
const App = {
  ...
  async init() {
    ...
    // Lands on the first tab in the module registry — avoids hardcoding a
    // key that might get removed/reordered later (like "dashboard" was).
    this.navigate(Object.keys(this.modules)[0]);
