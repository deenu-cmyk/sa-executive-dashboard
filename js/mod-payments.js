    ...
    main.innerHTML = `
      <div class="panel">
        ...
        ${Components.dataTable(rows, [
          ...
          // TODO: "Status" is showing as undefined for every row — the CSV column
          // this reads from is likely named something other than "Status" (or is
          // blank). Once you confirm the real column name, swap it in below.
          { key: "Status", label: "Status", fmt: (v) => Components.statusBadge(v || "Unknown") },
        ], { limit: 200 })}
      </div>
